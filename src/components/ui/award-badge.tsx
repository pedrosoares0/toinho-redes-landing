import React, { MouseEvent, useEffect, useRef, useState } from "react"; 
 ...
 const backgroundColor = ["#0047FF", "#00B2FF", "#002D62", "#0085FF"]; 
  
 export const AwardBadge = ({ topText, mainText, index, link }: AwardBadgeProps) => { 
   ...
   return ( 
     <div 
       ref={ref} 
       className="block w-[160px] sm:w-[220px] h-auto cursor-default pointer-events-auto" 
     ...
     > 
       ...
       > 
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="w-[160px] sm:w-[220px] h-auto"> 
           <defs> 
             <filter id="blur1"> 
               <feGaussianBlur in="SourceGraphic" stdDeviation="3" /> 
             </filter> 
             <mask id="badgeMask"> 
               <rect width="260" height="54" fill="white" rx="12" /> 
             </mask> 
           </defs> 
           <rect width="260" height="54" rx="12" fill={backgroundColor[index % backgroundColor.length]} /> 
           <rect x="4" y="4" width="252" height="46" rx="10" fill="transparent" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5" /> 
           <text fontFamily="Avenue, Helvetica" fontSize="10" fontWeight="900" fill="white" opacity="0.7" x="53" y="20" style={{ textTransform: 'uppercase', letterSpacing: '0.2em' }}> 
             {topText} 
           </text> 
           <text fontFamily="Avenue, Helvetica" fontSize="18" fontWeight="900" fill="white" x="52" y="40" style={{ textTransform: 'uppercase', letterSpacing: '0.05em' }}> 
             {mainText} 
           </text> 
           <g transform="translate(12, 11) scale(0.8)"> 
           ...
           <g style={{ mixBlendMode: "overlay" }} mask="url(#badgeMask)"> 
             <g style={{ 
               ...
               <polygon points="0,0 260,54 260,0 0,54" fill="hsl(220, 100%, 60%)" filter="url(#blur1)" opacity="0.6" /> 
             </g> 
             <g style={{ 
               transform: `rotate(${firstOverlayPosition + 15}deg)`, 
               transformOrigin: "center center", 
               transition: !disableInOutOverlayAnimation ? "transform 200ms ease-out" : "none", 
               animation: disableOverlayAnimation ? "none" : "overlayAnimation2 5s infinite", 
               willChange: "transform" 
             }}> 
               <polygon points="0,0 260,54 260,0 0,54" fill="hsl(200, 100%, 50%)" filter="url(#blur1)" opacity="0.6" /> 
             </g> 
             <g style={{ 
               ...
               <polygon points="0,0 260,54 260,0 0,54" fill="hsl(240, 100%, 50%)" filter="url(#blur1)" opacity="0.6" /> 
             </g> 
             <g style={{ 
               transform: `rotate(${firstOverlayPosition + 45}deg)`, 
               transformOrigin: "center center", 
               transition: !disableInOutOverlayAnimation ? "transform 200ms ease-out" : "none", 
               animation: disableOverlayAnimation ? "none" : "overlayAnimation4 5s infinite", 
               willChange: "transform" 
             }}> 
               <polygon points="0,0 260,54 260,0 0,54" fill="hsl(190, 100%, 50%)" filter="url(#blur1)" opacity="0.6" /> 
             </g> 
             <g style={{ 
               ...
               <polygon points="0,0 260,54 260,0 0,54" fill="hsl(210, 85%, 47%)" filter="url(#blur1)" opacity="0.6" /> 
             </g> 
             <g style={{ 
               transform: `rotate(${firstOverlayPosition + 75}deg)`, 
               transformOrigin: "center center", 
               transition: !disableInOutOverlayAnimation ? "transform 200ms ease-out" : "none", 
               animation: disableOverlayAnimation ? "none" : "overlayAnimation6 5s infinite", 
               willChange: "transform" 
             }}> 
               <polygon points="0,0 260,54 260,0 0,54" fill="hsl(230, 85%, 47%)" filter="url(#blur1)" opacity="0.6" /> 
             </g> 
             <g style={{ 
               ...
               <polygon points="0,0 260,54 260,0 0,54" fill="white" filter="url(#blur1)" opacity="0.4" /> 
             </g> 
           </g> 
         </svg> 
       </div> 
